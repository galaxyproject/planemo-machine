...
ENV ANSIBLE_EXTRA_VARS="--extra-vars galaxy_user_name=ubuntu --extra-vars galaxy_docker_sudo=true --extra-vars startup_chown_on_directory=/opt/galaxy/tools --extra-vars galaxy_devbox_include_x=$INCLUDE_X"
